    ...
    <main className="main-content">
        <section class="section">
            <div class="container">
                ...
                <h6 class="heading-alt">Types of Data collected</h6>
                ...
                <h6 class="heading-alt">Mode and place of processing the Data</h6>
                ...
                <br/>
                <h6 class="heading-alt">The use of the collected Data</h6>
                <p> 
                ...
                <h6 class="heading-alt">Detailed information on the processing of Personal Data</h6>
                ...
                <br/><br/> 
                <h6 class="heading-alt">Additional information about Data collection and processing  </h6>
                <br/>
                <p> 
